...
public class Product_details_Id implements IdentifierGenerator{
	private String prefix = "CTSP";

	@Override
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
		// Select all id
		QueryImplementor<String> query = session.createQuery("SELECT e.Id_Product_Details FROM product_details e", String.class);
