...
public class Product_Id implements IdentifierGenerator{
	private String prefix = "SP";

	@Override
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
		// Select all id
		QueryImplementor<String> query = session.createQuery("SELECT e.Id_Poroduct FROM product e", String.class);
