...
public class Category_Id implements IdentifierGenerator{
	private String prefix = "LH";

	@Override
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
		// Select all id
		QueryImplementor<String> query = session.createQuery("SELECT e.id FROM category e", String.class);
