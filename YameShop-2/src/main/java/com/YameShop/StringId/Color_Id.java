...
public class Color_Id implements IdentifierGenerator{
	private String prefix = "M";

	@Override
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
		// Select all id
		QueryImplementor<String> query = session.createQuery("SELECT e.Id_Product_Color FROM product_color e", String.class);
