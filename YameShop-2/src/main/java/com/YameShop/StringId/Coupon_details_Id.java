...
public class Coupon_details_Id implements IdentifierGenerator{
	private String prefix = "CTPN";

	@Override
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
		// Select all id
		QueryImplementor<String> query = session.createQuery("SELECT e.Id_Coupon_Details FROM coupon_details e", String.class);
